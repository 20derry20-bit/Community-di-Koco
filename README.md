...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    body::before {
      ...
      background:
        ...
        repeating-linear-gradient(
          ...
          transparent,
          transparent 60px,
          rgba(61,155,255,.04) 60px,
          rgba(61,155,255,.04) 61px
        ),
        repeating-linear-gradient(
          90deg,
          transparent,
    ...
    .discord-card:hover {
      box-shadow: 0 0 60px rgba(88,101,242,.3);
    }
...
<section class="section" id="magliette">
  <div class="section-title reveal"><span class="accent">Magliette</span> di Koco</div>
